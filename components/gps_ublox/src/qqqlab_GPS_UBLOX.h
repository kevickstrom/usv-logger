...
public:
    ...
    void update(); //update GPS instance. This should be called at 10Hz or greater
...
protected:
    ...
    uint32_t config_baud = 115200; //baudrate for initblob
    bool initblob_send();
  ...
  public:
    ...
    struct PACKED GPS_State {
        ...
        int32_t lng;                        ///< last fix location in 1E-7 degrees
        int32_t alt;                        ///< last fix altitude msl in mm 
        int32_t ground_speed;               ///< ground speed in mm/s
        int32_t ground_course;              ///< ground course in 1E-5 degrees
        ...
        int32_t vel_n;                      ///< 3D velocity in mm/s, in NED format
        int32_t vel_e;                      ///< 3D velocity in mm/s, in NED format
        int32_t vel_d;                      ///< 3D velocity in mm/s, in NED format               
        int32_t speed_accuracy;             ///< 3D velocity RMS accuracy estimate in mm/s
        int32_t horizontal_accuracy;        ///< horizontal RMS accuracy estimate in mm
        int32_t vertical_accuracy;          ///< vertical RMS accuracy estimate in mm
