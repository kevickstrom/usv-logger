...
#define RN2483_CONFIG_H

// Dummy default LoRaWAN settings (override in your actual config if needed)
#ifndef LoRaWAN_Frequency
#define LoRaWAN_Frequency "EU868"   // e.g., "EU868", "US915"
#endif

#ifndef LoRaWAN_DevAddr
#define LoRaWAN_DevAddr "00000000"  // 8-char hex string
#endif

#ifndef LoRaWAN_DevEUI
#define LoRaWAN_DevEUI "0000000000000000"  // 16-char hex string
#endif

#ifndef LoRaWAN_AppEUI
#define LoRaWAN_AppEUI "0000000000000000"  // 16-char hex string
#endif

#ifndef LoRaWAN_AppKey
#define LoRaWAN_AppKey "00000000000000000000000000000000"  // 32-char hex string
#endif

#ifndef LoRaWAN_DataRate
#define LoRaWAN_DataRate "0"   // default data rate
#endif

#ifndef LoRaWAN_Port
#define LoRaWAN_Port "1"       // default LoRa port
#endif

#endif // RN2483_CONFIG_H